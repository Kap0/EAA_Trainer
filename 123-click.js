...
// @name        123-Click
// @namespace   temp
// @include     https://www.davidschrammel.at/eaa/
// @version     1
// @grant       none
...
$(document).ready(function () {
  ...
  $('head').append($('<link rel="stylesheet" type="text/css" />').attr('href', 'https://dl.dropboxusercontent.com/u/35626216/eaa/eaaTrainer.css'));
  $('#info').hide();
  $('#error').hide();
  $('#stats').hide();
